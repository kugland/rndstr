...
This script generates random strings that can be used for passwords, keys &c.
...
`rndstr` is licensed under the MIT license, for more information, consult the
included file *LICENSE*.

## COPYRIGHT

Copyright (C) 2021 André Kugland [kugland@gmail.com](mailto:kugland@gmail.com)
